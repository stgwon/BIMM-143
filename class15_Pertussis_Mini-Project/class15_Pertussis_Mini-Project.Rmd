...
ggplot(cdc) +
  ...
  labs(x="Year", y="Number of cases",
       title="Pertussis Cases by Year (1922-2019)")
```
After the introduction of wP vaccine, Pertussis cases dropped significantly. However, after the introduction of aP vaccine, Pertussis cases increased.
**COME BACK TO THIS**

> Q3. Describe what happened after the introduction of the aP vaccine? Do you have a possible explanation for the observed trend?

#### Answer:
After the introduction of aP vaccine, Pertussis cases increased.
Hint:
...
#### Answer:
Yes, two groups are significantly different. 
**COME BACK TO THIS**
...
#### Answer:
The number of visit 8 specimens is significantly smaller than other visits.
**COME BACK TO THIS**
